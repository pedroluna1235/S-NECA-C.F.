...
import { Users, Shield, CalendarDays, Menu, X, Sun, Moon, BookOpen, Eye, LogOut, ClipboardList, Target, Flag } from 'lucide-react';
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { to: '/objetivos-grupales', icon: Flag, label: 'Objetivos Grupales' },
