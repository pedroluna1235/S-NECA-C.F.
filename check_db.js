...
async function testSign() {
  const { data, error } = await supabase.storage.from('FOTOS JUGADORES').createSignedUrl('cdh2f8zsk8d_1783766584619.JPG', 60);
  console.log('Signed URL Result:', data);
  if (error) console.log('Signed URL Error:', error);
}
